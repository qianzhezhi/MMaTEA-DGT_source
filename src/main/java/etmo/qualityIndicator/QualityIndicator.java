...
public class QualityIndicator {
	...
	public double getHypervolume(SolutionSet solutionSet, int taskID) {
		return new Hypervolume().hypervolume(solutionSet.writeObjectivesToMatrix(problem_.getStartObjPos(), problem_.getEndObjPos()),
				trueParetoFront_.writeObjectivesToMatrix(), problem_.getNumberOfObjectives());
	} // getHypervolume
