...
// Problem2 version ProblemSet

public class ProblemSet2 extends ProblemSet {
	protected final List<Problem2> problemsList_;
	...
	public ProblemSet2() {
		problemsList_ = new ArrayList<Problem2>();

	} // SolutionSet

	public ProblemSet2(int maximumSize) {
		problemsList_ = new ArrayList<Problem2>();
	...
	public ProblemSet2(int maximumSize, double low, double up) {
		problemsList_ = new ArrayList<Problem2>();
		accObjsList_ = new ArrayList<Integer>();
	...
	public ProblemSet2(String solutionType) {
		problemsList_ = new ArrayList<Problem2>();
		accObjsList_ = new ArrayList<Integer>();
	...
	public ProblemSet2(int maximumSize, String solutionType) {
		problemsList_ = new ArrayList<Problem2>();
		accObjsList_ = new ArrayList<Integer>();
	...
	public boolean add(Problem2 problem) {
	...
	public ProblemSet2 getTask(int i) {
		if (i >= problemsList_.size()) {
			throw new IndexOutOfBoundsException("Index out of Bound " + i);
		}
		ProblemSet2 problemSet = new ProblemSet2(1);
		problemSet.add(problemsList_.get(i));
		return problemSet;
	} // get
